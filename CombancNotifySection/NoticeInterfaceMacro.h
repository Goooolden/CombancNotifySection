...
#define NoticeBaseUrl (@"NoticeBaseUrl")
#define NewsImageURL ([NSString stringWithFormat:@"%@/file/upload",[[NSUserDefaults standardUserDefaults] objectForKey:NoticeBaseUrl]])
